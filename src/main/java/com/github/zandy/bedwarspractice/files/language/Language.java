...
public class Language {
    ...
    public enum MessagesEnum {
        ...
        NPC_HOLOGRAM_DEFAULT("NPC.Hologram.Default", Arrays.asList("&e&lCLICK TO PLAY", "&bPractice &7[0.1]", "&e&l%bwp_playing% Players")),
        NPC_HOLOGRAM_BRIDGING("NPC.Hologram.Bridging", Arrays.asList("&aBRIDGING", "&e&lCLICK TO PLAY", "&bPractice &7[0.1]", "&e&l%bwp_playing_bridging% Players")),
        NPC_HOLOGRAM_MLG("NPC.Hologram.MLG", Arrays.asList("&aMLG", "&e&lCLICK TO PLAY", "&bPractice &7[0.1]", "&e&l%bwp_playing_mlg% Players")),
        NPC_HOLOGRAM_FIREBALL_TNT_JUMPING("NPC.Hologram.Fireball-TNT-Jumping", Arrays.asList("&aFIREBALL/TNT JUMPING", "&e&lCLICK TO PLAY", "&bPractice &7[0.1]", "&e&l%bwp_playing_fireballtntjumping% Players")),
